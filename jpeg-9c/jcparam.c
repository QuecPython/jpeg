 ...
 *
 * This HeliosFILE contains optional default-setting code for the JPEG compressor.
 * Applications do not have to use this HeliosFILE, but those that don't use it
 ...
 */
{
  ...
  /* Initialize sent_table FALSE so table will be written to JPEG HeliosFILE. */
