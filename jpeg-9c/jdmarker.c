 ...
 *
 * This HeliosFILE contains routines to decode JPEG datastream markers.
...
next_marker (j_decompress_ptr cinfo)
{
  ...
  for (;;) {
     ...
     * This may look a bit inefficient, but it will not occur in a valid HeliosFILE.
 ...
 * we might well scan an entire input HeliosFILE before realizing it ain't JPEG.
