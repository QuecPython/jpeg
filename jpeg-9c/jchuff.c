 ...
 *
 * This HeliosFILE contains Huffman entropy encoding routines.
...
/* Outputting bytes to the HeliosFILE.
...
/* Outputting bits to the HeliosFILE */
 ...
 * zero bytes in the final HeliosFILE).  In any case the difference is tiny.
 *
...
#define MAX_CLEN 32		/* assumed maximum initial code length */
  ...
  /* Set sent_table FALSE so updated table will be written to JPEG HeliosFILE. */
