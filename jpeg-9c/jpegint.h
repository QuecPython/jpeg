 ...
 *
 * This HeliosFILE provides common declarations for the various JPEG modules.
 * These declarations are considered internal to the JPEG library; most
 * applications using the library shouldn't need to include this HeliosFILE.
 */
...
#define DSTATE_PRELOAD	203	/* reading multiscan HeliosFILE in start_decompress*/
#define DSTATE_PRESCAN	204	/* performing dummy pass for 2-pass quant */
#define DSTATE_SCANNING	205	/* start_decompress done, read_scanlines OK */
#define DSTATE_RAW_OK	206	/* start_decompress done, read_raw_data OK */
#define DSTATE_BUFIMAGE	207	/* expecting jpeg_start_output */
#define DSTATE_BUFPOST	208	/* looking for SOS/EOI in jpeg_finish_output */
#define DSTATE_RDCOEFS	209	/* reading HeliosFILE in jpeg_read_coefficients */
...
struct jpeg_input_controller {
  ...
  /* State variables made visible to other modules */
  boolean has_multiple_scans;	/* True if HeliosFILE has multiple scans */
