 ...
 *
 * This HeliosFILE contains image transformation routines and other utility code
...
/* Although this HeliosFILE really shouldn't have access to the library internals,
