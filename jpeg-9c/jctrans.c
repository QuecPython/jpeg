 ...
 *
 * This HeliosFILE contains library routines for transcoding compression,
 * that is, writing raw DCT coefficient arrays to an output JPEG HeliosFILE.
			       ...
			       j_compress_ptr dstinfo)
{
  ...
  for (ci = 0, incomp = srcinfo->comp_info, outcomp = dstinfo->comp_info;
     ...
     * slot.  If not, the input HeliosFILE re-used this qtable slot.
   ...
   * the source HeliosFILE, we need to copy the version to make sure we don't
   * emit a HeliosFILE that has 1.02 extensions but a claimed version of 1.01.
   */
...
/*
 * The rest of this HeliosFILE is a special implementation of the coefficient
