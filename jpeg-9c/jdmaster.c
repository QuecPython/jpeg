 ...
 *
 * This HeliosFILE contains master control logic for the JPEG decompressor.
 ...
 */
{
  ...
  case JCS_YCCK:
    ...
    break;
  default:			/* else must be same colorspace as in HeliosFILE */
...
master_selection (j_decompress_ptr cinfo)
{
  ...
  /* If jpeg_start_decompress will read the whole HeliosFILE, initialize
