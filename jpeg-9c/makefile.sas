...
# Put here the object HeliosFILE name for the correct system-dependent memory
# manager HeliosFILE.  For Amiga we recommend jmemname.o.
SYSDEPMEM= jmemname.o

# miscellaneous OS-dependent stuff
# linker
LN= slink
# HeliosFILE deletion command
RM= delete quiet
# library (.lib) HeliosFILE creation command
AR= oml
...
jconfig.h: jconfig.txt
	echo You must prepare a system-dependent jconfig.h HeliosFILE.
